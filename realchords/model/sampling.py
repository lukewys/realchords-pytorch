...
def filter_invalid_tokens_generate_online(
    ...
    **kwargs,
    ...
    """Filter invalid tokens for online generation when generating a single part.

    i.e. using interleaving order but only generate chords or only generate melody.
    The other part is filled with ground-truth (pre-defined) tokens.
    """
...
def filter_invalid_tokens_generate_unconditional(
    ...
    **kwargs,
    ...
    """Filter invalid tokens for online generation when generating both parts.

    i.e. using interleaving order and generate chords and melody.
    """
...
def filter_invalid_tokens_generate_single_part(
    ...
    **kwargs,
    ...
    """Filter invalid tokens for single-part generation.

    i.e. only generate chords or only generate melody.
    """
