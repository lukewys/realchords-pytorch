...
Contains utility functions from openrlhf.models.utils and other utility modules.
"""
...
def compute_reward(
    ...
    Returns:
        Computed reward with KL penalty
    """
    if kl_coef <= 0.0:
        kl_coef = 0.0
...
def zero_pad_sequences(sequences: List[torch.Tensor], side: str = "left") -> torch.Tensor:
    ...
    Returns:
        Stacked tensor of padded sequences
    """
